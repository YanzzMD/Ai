        ...
        return Exp.sendMessage(number || id, {
            text:`${_text ? (_text + "\n\n" + text) : text}`,
                contextInfo: {
                    ...
                    mediaUrl: `http://wa.me/6282245186794/${!cust ? "89e838":"jeie337"}`,
        ...
        const menu = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    thumbnailUrl: url,
                    sourceUrl: "https://github.com/YanzzMD",
                    mediaUrl: "http://wa.me/6282245186794/"+Math.floor(Math.random() * 100000000000000000),
                    renderLargerThumbnail: true,
                    showAdAttribution: true,
                    mediaType: 1,
                },
        ...
        const mess = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    sourceUrl: "https://github.com/YanzzMD",
                    mediaUrl: `http://wa.me/6282245186794/${user.charging ? "2733":"2734"}`,
                    renderLargerThumbnail: true,
                    showAdAttribution: true,
                    mediaType: 1,
                }
